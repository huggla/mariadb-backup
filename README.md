# mariadb-backup
A tiny and simple Docker image for backing up Mariadb/Mysql. It runs mysqldump from Mariadb on Alpine Linux.

20181204: mysqldump from Mariadb 10.3.10, Alpine Edge.
